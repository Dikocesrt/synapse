...
import CourseOutcomeItem from "./CourseOutcomeItem";

interface CourseOutcomeSectionProps {
    courseOutcomes?: CourseOutcome[];
}

export default function CourseOutcomeSection({
    courseOutcomes,
}: CourseOutcomeSectionProps) {
    return (
